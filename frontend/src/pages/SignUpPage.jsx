...
import { Loader, Lock, Mail, User, UserCheck, BookOpen } from "lucide-react";
...
const SignUpPage = () => {
	...
	const handleSignUp = async (e) => {
		...
		try {
			await signup(email, password, name, role, course);
				...
				<form onSubmit={handleSignUp}>
					...
					<div className='relative mb-6'>
						...
						<select
							...
							className='w-full pl-10 pr-3 py-2 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-700 focus:border-green-500 focus:ring-2 focus:ring-green-500 text-white transition duration-200'
						>
